...
enum Watch
{
  ...
  WATCH_DISCONNECTS, WATCH_DLINES, WATCH_DLINE_MATCHES, WATCH_FLOODERS,
  WATCH_GLINES, WATCH_GLINE_MATCHES, WATCH_INFOS, WATCH_JUPES, WATCH_KILLS,
  WATCH_KLINES, WATCH_KLINE_MATCHES, WATCH_LINKS, WATCH_MOTDS, WATCH_MSGS,
  WATCH_NICK_CHANGES, WATCH_OPERFAILS, WATCH_SEEDRAND, WATCH_SPAMBOTS,
  WATCH_SPAMTRAP, WATCH_STATS, WATCH_TOOMANYS, WATCH_TRACES, WATCH_TRAPS,
  WATCH_WALLOPS, NUM_WATCHES,
