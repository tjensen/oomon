...
enum Watch
{
  WATCH_CHAT, WATCH_CONNECTS, WATCH_CONNFLOOD, WATCH_CTCPVERSIONS,
  WATCH_DISCONNECTS, WATCH_DLINES, WATCH_DLINE_MATCHES, WATCH_DNSBL,
  WATCH_FLOODERS, WATCH_GLINES, WATCH_GLINE_MATCHES, WATCH_INFOS, WATCH_JUPES,
  WATCH_KILLS, WATCH_KLINES, WATCH_KLINE_MATCHES, WATCH_LINKS, WATCH_MOTDS,
  WATCH_MSGS, WATCH_NICK_CHANGES, WATCH_NOTICES, WATCH_OPERFAILS,
  WATCH_PROXYSCANS, WATCH_SEEDRAND, WATCH_SPAMBOTS, WATCH_SPAMTRAP,
  WATCH_STATS, WATCH_TOOMANYS, WATCH_TRACES, WATCH_TRAPS, WATCH_WALLOPS,
  NUM_WATCHES,
