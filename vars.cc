...
Vars::Vars()
  : vec(VAR_COUNT)
{
  this->vec[VAR_AUTO_KLINE_HOST] = new BoolSetting("AUTO_KLINE_HOST",
    DEFAULT_AUTO_KLINE_HOST);
  this->vec[VAR_AUTO_KLINE_HOST_REASON] =
    new StrSetting("AUTO_KLINE_HOST_REASON", DEFAULT_AUTO_KLINE_HOST_REASON);
  this->vec[VAR_AUTO_KLINE_HOST_TIME] = new IntSetting("AUTO_KLINE_HOST_TIME",
    DEFAULT_AUTO_KLINE_HOST_TIME, 0);
  this->vec[VAR_AUTO_KLINE_NET] = new BoolSetting("AUTO_KLINE_NET",
    DEFAULT_AUTO_KLINE_NET);
  this->vec[VAR_AUTO_KLINE_NET_REASON] =
    new StrSetting("AUTO_KLINE_NET_REASON", DEFAULT_AUTO_KLINE_NET_REASON);
  this->vec[VAR_AUTO_KLINE_NET_TIME] = new IntSetting("AUTO_KLINE_NET_TIME",
    DEFAULT_AUTO_KLINE_NET_TIME, 0);
  this->vec[VAR_AUTO_KLINE_NOIDENT] = new BoolSetting("AUTO_KLINE_NOIDENT",
    DEFAULT_AUTO_KLINE_NOIDENT);
  this->vec[VAR_AUTO_KLINE_NOIDENT_REASON] =
    new StrSetting("AUTO_KLINE_NOIDENT_REASON",
    DEFAULT_AUTO_KLINE_NOIDENT_REASON);
  this->vec[VAR_AUTO_KLINE_NOIDENT_TIME] =
    new IntSetting("AUTO_KLINE_NOIDENT_TIME", DEFAULT_AUTO_KLINE_NOIDENT_TIME,
    0);
  this->vec[VAR_AUTO_KLINE_USERHOST] = new BoolSetting("AUTO_KLINE_USERHOST",
    DEFAULT_AUTO_KLINE_USERHOST);
  this->vec[VAR_AUTO_KLINE_USERHOST_REASON] =
    new StrSetting("AUTO_KLINE_USERHOST_REASON",
    DEFAULT_AUTO_KLINE_USERHOST_REASON);
  this->vec[VAR_AUTO_KLINE_USERHOST_TIME] =
    new IntSetting("AUTO_KLINE_USERHOST_TIME", DEFAULT_AUTO_KLINE_USERHOST_TIME,
    0);
  this->vec[VAR_AUTO_KLINE_USERNET] = new BoolSetting("AUTO_KLINE_USERNET",
    DEFAULT_AUTO_KLINE_USERNET);
  this->vec[VAR_AUTO_KLINE_USERNET_REASON] =
    new StrSetting("AUTO_KLINE_USERNET_REASON",
    DEFAULT_AUTO_KLINE_USERNET_REASON);
  this->vec[VAR_AUTO_KLINE_USERNET_TIME] =
    new IntSetting("AUTO_KLINE_USERNET_TIME", DEFAULT_AUTO_KLINE_USERNET_TIME,
    0);
  ...
  this->vec[VAR_CLONE_MAX_TIME] = new IntSetting("CLONE_MAX_TIME",
    DEFAULT_CLONE_MAX_TIME, 1);
  this->vec[VAR_CLONE_MIN_COUNT] = new IntSetting("CLONE_MIN_COUNT",
    DEFAULT_CLONE_MIN_COUNT, 2);
  this->vec[VAR_CLONE_REPORT_FORMAT] =
    new StrSetting("CLONE_REPORT_FORMAT", DEFAULT_CLONE_REPORT_FORMAT);
  this->vec[VAR_CLONE_REPORT_INTERVAL] = new IntSetting("CLONE_REPORT_INTERVAL",
    DEFAULT_CLONE_REPORT_INTERVAL, 1);
  this->vec[VAR_CONNECT_FLOOD_ACTION] =
    new ActionSetting("CONNECT_FLOOD_ACTION", DEFAULT_CONNECT_FLOOD_ACTION,
    DEFAULT_CONNECT_FLOOD_ACTION_TIME);
  this->vec[VAR_CONNECT_FLOOD_MAX_COUNT] =
    new IntSetting("CONNECT_FLOOD_MAX_COUNT", DEFAULT_CONNECT_FLOOD_MAX_COUNT,
    0);
  this->vec[VAR_CONNECT_FLOOD_MAX_TIME] =
    new IntSetting("CONNECT_FLOOD_MAX_TIME", DEFAULT_CONNECT_FLOOD_MAX_TIME, 1);
  this->vec[VAR_CONNECT_FLOOD_REASON] =
    new StrSetting("CONNECT_FLOOD_REASON", DEFAULT_CONNECT_FLOOD_REASON);
  ...
  this->vec[VAR_OPERFAIL_ACTION] =
    new ActionSetting("OPERFAIL_ACTION", DEFAULT_OPERFAIL_ACTION);
  this->vec[VAR_OPERFAIL_MAX_COUNT] =
    new IntSetting("OPERFAIL_MAX_COUNT", DEFAULT_OPERFAIL_MAX_COUNT, 0);
  this->vec[VAR_OPERFAIL_MAX_TIME] =
    new IntSetting("OPERFAIL_MAX_TIME", DEFAULT_OPERFAIL_MAX_TIME, 1);
  this->vec[VAR_OPERFAIL_REASON] =
    new StrSetting("OPERFAIL_REASON", DEFAULT_OPERFAIL_REASON);
  ...
  this->vec[VAR_TRACK_PERM_DLINES] =
    new BoolSetting("TRACK_PERM_DLINES", DEFAULT_TRACK_PERM_DLINES);
  this->vec[VAR_TRACK_PERM_KLINES] =
    new BoolSetting("TRACK_PERM_KLINES", DEFAULT_TRACK_PERM_KLINES);
  ...
  this->vec[VAR_WATCH_OPERFAIL_NOTICES] =
    new BoolSetting("WATCH_OPERFAIL_NOTICES", DEFAULT_WATCH_OPERFAIL_NOTICES);
